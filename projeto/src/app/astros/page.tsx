    ...
    <div className="container mx-auto p-4">
      <div className="flex flex-row justify-around rounded-3xl shadow-md shadow-purple-900 p-10">
        <div className="w-50 text-left">
          <h1 className="text-3xl font-bold mb-4">Reinterpretação da Astronomia e da Física:</h1>
          <p className="mr-10 text-xl">V
            elikovsky desafia a visão científica tradicional, sugerindo que planetas podem ter órbitas instáveis e que eventos astronômicos recentes (nos últimos milhares de anos) afetaram a Terra. Ele questiona a cronologia estabelecida e a estabilidade dos sistemas planetários, o que é contrário às leis da física moderna.
          </p>
        </div>
        <div className="w-30">
          {catastrophes.length > 0 && (
            <img src={catastrophes[40].url} alt={catastrophes[40].title} className="w-30 h-30 mb-4" />
          )}
        </div>
      </div>
